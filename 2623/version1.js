...
function memoize(fn) {
  ...
  return function (...args) {
    ...
    // 1. Call the original function with the provided arguments
    // 2. Store the result in the cache using the stringified key
    cache.set(key, fn(...args));
    return cache.get(key); // Return the newly computed result
  };
}
